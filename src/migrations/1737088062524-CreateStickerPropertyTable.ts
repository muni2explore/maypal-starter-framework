        ...
        await queryRunner.createTable(
            new Table({
                ...
                columns: [
                    ...
                    { name: "maximumUsers", type: "int", isNullable: false, default: 4 },
                    { name: "stickerPin", type: "varchar", length: "6", isNullable: false },
                    { name: "itemTypeId", type: "int", isNullable: false },
                    { name: "callTypeId", type: "int", isNullable: false },
