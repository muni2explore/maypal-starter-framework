...
export class CreateMapPalVideoCallTable1737092124563 implements MigrationInterface {

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.createTable(
            new Table({
                name: "map_pal_video_call",
                columns: [
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.dropTable("map_pal_video_call");
    }
}